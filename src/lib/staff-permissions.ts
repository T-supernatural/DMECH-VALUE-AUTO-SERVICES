...
export const OPS_NAV_ITEMS = [
  ...
  { id: "sourcing", href: "/ops/sourcing", label: "Sourcing Catalog", section: "Sourcing" },
  { id: "pre-orders", href: "/ops/pre-orders", label: "Pre-Orders", section: "Sourcing" },
  { id: "vehicle-requests", href: "/ops/vehicle-requests", label: "Vehicle Requests", section: "Sourcing" },
